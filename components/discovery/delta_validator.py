from shared.models import DeviceDeltaResult, DeviceDiscoveryRecord, SegmentType
from shared.config.settings import DiscoveryConfig
...
class DeltaValidator:
    ...
    def __init__(self, threshold_pct: float = None):
        self.threshold = (
            ...
            else DiscoveryConfig.DELTA_THRESHOLD
        )
